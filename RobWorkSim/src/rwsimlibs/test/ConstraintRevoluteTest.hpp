...
#ifndef RWSIMLIBS_TEST_CONSTRAINTREVOLUTETEST_HPP_
#define RWSIMLIBS_TEST_CONSTRAINTREVOLUTETEST_HPP_

/**
 * @file ConstraintRevoluteTest.hpp
 *
 * \copydoc rwsimlibs::test::ConstraintRevoluteTest
 */
 ...
 */
class ConstraintRevoluteTest: public EngineTest {
public:
	//! @brief Smart pointer to ConstraintRevoluteTest.
	typedef rw::common::Ptr<ConstraintRevoluteTest> Ptr;

	//! @brief Constructor.
	ConstraintRevoluteTest();

	//! @brief Destructor.
	virtual ~ConstraintRevoluteTest();
...
#endif /* RWSIMLIBS_TEST_CONSTRAINTREVOLUTETEST_HPP_ */
