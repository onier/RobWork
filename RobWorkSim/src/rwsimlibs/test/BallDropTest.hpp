...
#ifndef RWSIMLIBS_TEST_BALLDROPTEST_HPP_
#define RWSIMLIBS_TEST_BALLDROPTEST_HPP_

/**
 * @file BallDropTest.hpp
 *
 * \copydoc rwsimlibs::test::BallDropTest
 */
 ...
 */
class BallDropTest: public EngineTest {
public:
	//! @brief Constructor.
	BallDropTest();

	//! @brief Destructor.
	virtual ~BallDropTest();
...
#endif /* RWSIMLIBS_TEST_BALLDROPTEST_HPP_ */
