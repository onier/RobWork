...
#ifndef RWSIMLIBS_TEST_BOWLFEEDERDROPTEST_HPP_
#define RWSIMLIBS_TEST_BOWLFEEDERDROPTEST_HPP_

/**
 * @file BowlFeederDropTest.hpp
 *
 * \copydoc rwsimlibs::test::BowlFeederDropTest
 */
 ...
 */
class BowlFeederDropTest: public EngineTest {
public:
	//! @brief Constructor.
	BowlFeederDropTest();

	//! @brief Destructor.
	virtual ~BowlFeederDropTest();
...
#endif /* RWSIMLIBS_TEST_BOWLFEEDERDROPTEST_HPP_ */
