...
#ifndef RWSIMLIBS_TEST_COLLISIONBOUNCINGBALLTEST_HPP_
#define RWSIMLIBS_TEST_COLLISIONBOUNCINGBALLTEST_HPP_

/**
 * @file CollisionBouncingBallTest.hpp
 *
 * \copydoc rwsimlibs::test::CollisionBouncingBallTest
 */
 ...
 */
class CollisionBouncingBallTest: public EngineTest {
public:
	//! @brief Smart pointer to CollisionBouncingBallTest.
	typedef rw::common::Ptr<CollisionBouncingBallTest> Ptr;

	//! @brief Constructor.
	CollisionBouncingBallTest();

	//! @brief Destructor.
	virtual ~CollisionBouncingBallTest();
...
#endif /* RWSIMLIBS_TEST_COLLISIONBOUNCINGBALLTEST_HPP_ */
