...
#ifndef RWSIMLIBS_TEST_COLLISIONBOUNCINGCYLINDERTEST_HPP_
#define RWSIMLIBS_TEST_COLLISIONBOUNCINGCYLINDERTEST_HPP_

/**
 * @file CollisionBouncingCylinderTest.hpp
 *
 * \copydoc rwsimlibs::test::CollisionBouncingCylinderTest
 */
 ...
 */
class CollisionBouncingCylinderTest: public EngineTest {
public:
	//! @brief Smart pointer to CollisionBouncingCylinderTest.
	typedef rw::common::Ptr<CollisionBouncingCylinderTest> Ptr;

	//! @brief Constructor.
	CollisionBouncingCylinderTest();

	//! @brief Destructor.
	virtual ~CollisionBouncingCylinderTest();
...
#endif /* RWSIMLIBS_TEST_COLLISIONBOUNCINGCYLINDERTEST_HPP_ */
