...
#ifndef RWSIMLIBS_TEST_TUBEPLANETEST_HPP_
#define RWSIMLIBS_TEST_TUBEPLANETEST_HPP_

/**
 * @file TubePlaneTest.hpp
 *
 * \copydoc rwsimlibs::test::TubePlaneTest
 */
 ...
 */
class TubePlaneTest: public EngineTest {
public:
	//! @brief Constructor.
	TubePlaneTest();

	//! @brief Destructor.
	virtual ~TubePlaneTest();
...
#endif /* RWSIMLIBS_TEST_TUBEPLANETEST_HPP_ */
