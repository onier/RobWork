...
#ifndef RWSIMLIBS_TEST_PIHCOMPLIANTTEST_HPP_
#define RWSIMLIBS_TEST_PIHCOMPLIANTTEST_HPP_

/**
 * @file PiHCompliantTest.hpp
 *
 * \copydoc rwsimlibs::test::PiHCompliantTest
 */
 ...
 */
class PiHCompliantTest: public EngineTest {
public:
	//! @brief Smart pointer to PiHCompliantTest.
	typedef rw::common::Ptr<PiHCompliantTest> Ptr;

	//! @brief Constructor.
	PiHCompliantTest();

	//! @brief Destructor.
	virtual ~PiHCompliantTest();
...
#endif /* RWSIMLIBS_TEST_PIHCOMPLIANTTEST_HPP_ */
