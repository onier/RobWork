...
#ifndef RWSIMLIBS_TEST_KVMTEST_HPP_
#define RWSIMLIBS_TEST_KVMTEST_HPP_

/**
 * @file KVMTest.hpp
 *
 * \copydoc rwsimlibs::test::KVMTest
 */
 ...
 */
class KVMTest: public EngineTest {
public:
	//! @brief Constructor.
	KVMTest();
...
#endif /* RWSIMLIBS_TEST_KVMTEST_HPP_ */
