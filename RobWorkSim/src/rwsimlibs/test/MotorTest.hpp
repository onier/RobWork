...
#ifndef RWSIMLIBS_TEST_MOTORTEST_HPP_
#define RWSIMLIBS_TEST_MOTORTEST_HPP_

/**
 * @file MotorTest.hpp
 *
 * \copydoc rwsimlibs::test::MotorTest
 */
 ...
 */
class MotorTest: public EngineTest {
public:
	//! @copydoc Constructor.
	MotorTest();
...
#endif /* RWSIMLIBS_TEST_MOTORTEST_HPP_ */
