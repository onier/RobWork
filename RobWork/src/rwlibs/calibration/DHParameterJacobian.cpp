...
namespace rwlibs {
	namespace calibration {
		DHParameterJacobian::DHParameterJacobian(DHParameterCalibration::Ptr calibration) : JacobianBase(calibration), _calibration(calibration), _joint(calibration->getJoint()) {
		}
