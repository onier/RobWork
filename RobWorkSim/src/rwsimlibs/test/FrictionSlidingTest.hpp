...
#ifndef RWSIMLIBS_TEST_FRICTIONSLIDINGTEST_HPP_
#define RWSIMLIBS_TEST_FRICTIONSLIDINGTEST_HPP_

/**
 * @file FrictionSlidingTest.hpp
 *
 * \copydoc rwsimlibs::test::FrictionSlidingTest
 */
 ...
 */
class FrictionSlidingTest: public EngineTest {
public:
	//! @brief Smart pointer to FrictionSlidingTest.
	typedef rw::common::Ptr<FrictionSlidingTest> Ptr;

	//! @brief Constructor.
	FrictionSlidingTest();

	//! @brief Destructor.
	virtual ~FrictionSlidingTest();
...
#endif /* RWSIMLIBS_TEST_FRICTIONSLIDINGTEST_HPP_ */
