#include "GraspTableGeneratorDialog.hpp"
...
void GraspTableGeneratorDialog::open(rw::models::WorkCell* workcell){
...
bool GraspTableGeneratorDialog::saveRestingState(int simidx, SimulatorPtr sim , const rw::kinematics::State& state ){
...
void GraspTableGeneratorDialog::updateStatus(){
...
void GraspTableGeneratorDialog::calcColFreeRandomCfg(rw::kinematics::State& state){
...
void GraspTableGeneratorDialog::genericEventListener(const std::string& event){
