...
#ifndef RWSIMLIBS_TEST_FRICTIONSTATICTEST_HPP_
#define RWSIMLIBS_TEST_FRICTIONSTATICTEST_HPP_

/**
 * @file FrictionStaticTest.hpp
 *
 * \copydoc rwsimlibs::test::FrictionStaticTest
 */
 ...
 */
class FrictionStaticTest: public EngineTest {
public:
	//! @brief Smart pointer to FrictionStaticTest.
	typedef rw::common::Ptr<FrictionStaticTest> Ptr;

	//! @brief Constructor.
	FrictionStaticTest();

	//! @brief Destructor.
	virtual ~FrictionStaticTest();
...
#endif /* RWSIMLIBS_TEST_FRICTIONSTATICTEST_HPP_ */
