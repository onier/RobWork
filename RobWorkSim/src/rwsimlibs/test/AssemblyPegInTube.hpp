...
#ifndef RWSIMLIBS_TEST_ASSEMBLYPEGINTUBE_HPP_
#define RWSIMLIBS_TEST_ASSEMBLYPEGINTUBE_HPP_

/**
 * @file AssemblyPegInTube.hpp
 *
 * \copydoc rwsimlibs::test::AssemblyPegInTube
 */
 ...
 */
class AssemblyPegInTube: public EngineTest {
public:
	//! @brief Constructor.
	AssemblyPegInTube();

	//! @brief Destructor.
	virtual ~AssemblyPegInTube();
...
#endif /* RWSIMLIBS_TEST_ASSEMBLYPEGINTUBE_HPP_ */
