...
#ifndef RWSIMLIBS_TEST_TWOFINGERGRASPTEST_HPP_
#define RWSIMLIBS_TEST_TWOFINGERGRASPTEST_HPP_

/**
 * @file TwoFingerGraspTest.hpp
 *
 * \copydoc rwsimlibs::test::TwoFingerGraspTest
 */
 ...
 */
class TwoFingerGraspTest: public EngineTest {
public:
	//! @brief Constructor.
	TwoFingerGraspTest();

	//! @brief Destructor.
	virtual ~TwoFingerGraspTest();
...
#endif /* RWSIMLIBS_TEST_TWOFINGERGRASPTEST_HPP_ */
