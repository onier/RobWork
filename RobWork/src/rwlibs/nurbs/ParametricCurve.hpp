...
#ifndef RWLIBS_NURBS_PARAMETRICCURVE_HPP_
#define RWLIBS_NURBS_PARAMETRICCURVE_HPP_

/**
 * @file ParametricCurve.hpp
 *
 * \copydoc rwlibs::nurbs::ParametricCurve
 */
...
//! @addtogroup nurbs
//! @{
class ParametricCurve: public rw::geometry::GeometryData {
public:
	...
	virtual rw::math::Vector3D<> evaluate(double t) = 0;
};
//! @}
} /* namespace nurbs */
} /* namespace rwlibs */
#endif /* RWLIBS_NURBS_PARAMETRICCURVE_HPP_ */
