...
#ifndef RWSIMLIBS_TEST_KVMNUTPLANETEST_HPP_
#define RWSIMLIBS_TEST_KVMNUTPLANETEST_HPP_

/**
 * @file KVMNutPlaneTest.hpp
 *
 * \copydoc rwsimlibs::test::KVMNutPlaneTest
 */
 ...
 */
class KVMNutPlaneTest: public EngineTest {
public:
	//! @brief Constructor.
	KVMNutPlaneTest();

	//! @brief Destructor.
	virtual ~KVMNutPlaneTest();
...
#endif /* RWSIMLIBS_TEST_KVMNUTPLANETEST_HPP_ */
